...
interface INormalizedDate {
	byIds: { [key: string]: IUnnormalizedData };
	allIds: string[]
}

const normalizeData = (unnormalizedData: IUnnormalizedData[]): INormalizedDate => {
	const byIds: { [key: string]: IUnnormalizedData } = {}
	const allIds: string[] = [];
